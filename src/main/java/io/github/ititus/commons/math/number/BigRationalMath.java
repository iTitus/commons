...
import io.github.ititus.commons.math.calculation.NewtonApproximator;
import io.github.ititus.commons.math.calculation.PowerSeriesCalculator;
...
public final class BigRationalMath {
    ...
    public static BigRational exp(BigRational x) {
        if (x.isZero()) {
            ...
            BigRational exp = PowerSeriesCalculator.exp(x.divide(BigRational.of(n)));
            return exp.pow(n);
        }
