...
public final class BigComplex {
    ...
    public static BigComplex of(BigRational real, BigRational imag) {
        ...
        if (z.equals(BigComplexConstants.ZERO)) {
            return BigComplexConstants.ZERO;
        } else if (z.equals(BigComplexConstants.ONE)) {
            return BigComplexConstants.ONE;
        } else if (z.equals(BigComplexConstants.I)) {
            return BigComplexConstants.I;
        } else if (z.equals(BigComplexConstants.MINUS_ONE)) {
            return BigComplexConstants.MINUS_ONE;
        } else if (z.equals(BigComplexConstants.MINUS_I)) {
            return BigComplexConstants.MINUS_I;
        }
