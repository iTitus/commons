...
public final class BigRationalConstants {
    ...
    public static final BigRational TWO = BigRational.of(2);
    ...
    public static final BigRational THREE = BigRational.of(3);
    ...
    public static final BigRational FOUR = BigRational.of(4);
    ...
    public static final BigRational FIVE = BigRational.of(5);
    ...
    public static final BigRational SIX = BigRational.of(6);
    ...
    public static final BigRational SEVEN = BigRational.of(7);
    ...
    public static final BigRational EIGHT = BigRational.of(8);
    ...
    public static final BigRational NINE = BigRational.of(9);
    ...
    public static final BigRational TEN = BigRational.of(10);
    ...
    public static final BigRational PI = BigRational.of(
    ...
    public static final BigRational E = BigRational.of(
