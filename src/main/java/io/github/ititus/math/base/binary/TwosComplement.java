...
public final class TwosComplement {
    ...
    public int decodeToInt(BinaryNumber bn) {
        ...
        int n = BaseConverters.BINARY.decodeToInt(bn);
        return neg ? -n : n;
    }
    ...
    public long decodeToLong(BinaryNumber bn) {
        ...
        long n = BaseConverters.BINARY.decodeToLong(bn);
        return neg ? -n : n;
    }
    ...
    public BigInteger decodeToBigInteger(BinaryNumber bn) {
        ...
        BigInteger n = BaseConverters.BINARY.decodeToBigInteger(bn);
    ...
    public BinaryNumber encode(int n) {
        ...
        boolean neg = n < 0;
        BinaryNumber bn = BaseConverters.BINARY.encodeToBinaryNumber(neg ? Math.negateExact(n) : n);
    ...
    public BinaryNumber encode(BigInteger n) {
        BinaryNumber bn = BaseConverters.BINARY.encodeToBinaryNumber(n.abs());
